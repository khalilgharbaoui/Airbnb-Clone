...
funny = Car.create(
model: "Funny car", description: "Experience this amazing car, and reach your destination in style", imgae: "http://media.gadgetblog.it/p/pim/pimp-my-wagen/new_beetle_tartaruga_wagen.jpg", begin_date: Date.parse("2010-01-01"), end_date: Date.parse("2010-01-01"), price: 5000, location: "Amsterdam", provider_id: petersen.id
)
